...
typedef void transfer_function_t(x86::ArchState& arch, z3::solver& solver, const cores::Core& core);
...
void sym_strncasecmp(x86::ArchState& arch, z3::solver& solver, const cores::Core& core);
